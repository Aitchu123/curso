...
import PromoBannerPT from '../../components/ui/PromoBannerPT';
...
export default function PTPage() {
  ...
  const handlePayment = () => {
    ...
    window.open('https://pay.kiwify.com/fC6tiT5', '_blank');
  };
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      "instructor": {
        ...
        "description": "Maior influenciador de instrumentação cirúrgica de Portugal e Brasil",
        "sameAs": "https://instagram.com/instrumentandoo"
      },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-green-50 font-['Inter'] overflow-x-hidden flex flex-col items-center">
      {/* Hero Section */}
      <Section 
        background="gradient" 
        padding="xl" 
        className="relative min-h-screen flex items-center justify-center pt-16 md:pt-20 w-full max-w-7xl mx-auto"
      >
        {/* Background Pattern */}
              ...
              >
                <MagicCard className="p-1 bg-gradient-to-br from-blue-600 to-green-600">
                  <iframe
                    ...
                    allow="autoplay"
                    title="Apresentação do Curso de Instrumentação Cirúrgica - Portugal"
                  ></iframe>
                </MagicCard>
                <div className="mt-6">
                  <PromoBannerPT onBuy={handlePayment} />
                </div>
              </motion.div>
            </FadeIn>
          </Grid>
      ...
      {/* Professor Section */}
      <section className="py-16 lg:py-24 bg-white w-full max-w-7xl mx-auto">
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-green-50 border-0 shadow-xl">
              <CardContent className="p-8 lg:p-12">
                ...
                <p className="text-xl text-blue-600 font-semibold mb-8">
                  MAIOR Influenciador de Instrumentação Cirúrgica de Portugal e Brasil
                </p>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-green-900 w-full max-w-7xl mx-auto">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Conteúdo do Curso */}
      <div className="py-20 bg-white w-full max-w-7xl mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="max-w-5xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold mb-8 text-gray-800">
              Equipes de cirurgiões e empresas de Portugal e Brasil solicitam indicações para Urolaser
            </h2>
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
              Profissionais formados pela nossa escola são reconhecidos e indicados em todo território português e brasileiro. 
            ...
            <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-2xl p-8 shadow-xl">
              ...
              <div className="mt-8 text-center">
                <p className="text-lg text-gray-700 mb-6">
                  "Fui indicado pela Urolaser e em menos de 15 dias já estava trabalhando em uma das maiores clínicas de Lisboa. 
                ...
                <p className="text-sm text-gray-600 mt-4">
                  +2.500 alunos já foram contratados através de indicações da Urolaser em Portugal e Brasil
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      {/* CTA Final Section */}
      <section className="py-16 lg:py-24 bg-gradient-to-br from-gray-900 via-blue-900 to-green-900 text-white w-full max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                ...
                >
                  ...
                  GARANTIR MINHA VAGA EM PORTUGAL
                </RainbowButton>                              
              </div>
            </motion.div>
          </FadeIn>
      ...
      {/* Footer */}
      <footer className="bg-black text-white py-8 w-full max-w-7xl mx-auto">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeIn>
            <p className="text-gray-400">
              © 2025 Escola Urolaser - Curso de Instrumentação Cirúrgica Portugal. Todos os direitos reservados. | 
      ...
      <WhatsAppButtonFoguete phoneNumber="553591007600" />
    </div>
  );
}
