        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="space-y-2">
            ...
            <div className="flex items-end gap-3">
              <span className="text-3xl lg:text-4xl font-extrabold tracking-tight">de <span className="line-through decoration-red-500 decoration-2">R$499,00</span> para R$167,00</span>
