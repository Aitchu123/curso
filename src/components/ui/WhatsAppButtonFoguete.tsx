...
const WhatsAppButtonFoguete: React.FC<{ message?: string }> = ({ message = 'Quero saber mais' }) => {
  const handleWhatsAppClick = () => {
    ...
    const pool = ['5521972762708', '5512978133810', '5512982044856'];
    let idx = 0;
    try {
    ...
    window.open(`http://wa.me/${targetNumber}?text=${encodedMessage}`, '_blank');
  };
...
export default WhatsAppButtonFoguete;
