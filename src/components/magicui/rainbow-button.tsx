  ...
  return (
    <button
      ...
      className={cn(
        ...
        // light mode colors - usando cores mais claras
        "bg-[linear-gradient(#ffffff,#ffffff),linear-gradient(#ffffff_50%,rgba(255,255,255,0.8)_80%,rgba(255,255,255,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
        // dark mode colors
      ...
      {...props}
    >
      <span className="relative z-10 text-gray-800 dark:text-white font-bold">
        {children}
      </span>
    </button>
  );
